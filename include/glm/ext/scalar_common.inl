...
|| GLM_CONFIG_UNRESTRICTED_FLOAT, "'fmin' only accept floating-point input");
...
{
GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559
|| GLM_CONFIG_UNRESTRICTED_FLOAT, "'fmax' only accept floating-point input");
...
|| GLM_CONFIG_UNRESTRICTED_FLOAT, "'fclamp' only accept floating-point or integer inputs");
return
...
{
GLM_STATIC_ASSERT(std::numeric_limits<genType>::is_iec559
|| GLM_CONFIG_UNRESTRICTED_FLOAT, "'uround' only accept floating-point inputs");
assert(static_cast<genType>(0.0) <= x);
