namespace glm {
    ...
    || GLM_CONFIG_UNRESTRICTED_FLOAT, "'mix' only accept floating-point inputs");
...
qua <T, Q> lerp(qua < T, Q >
const& x,
qua <T, Q> const &y, T
a)
{
GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559
|| GLM_CONFIG_UNRESTRICTED_FLOAT, "'lerp' only accept floating-point inputs");
...
{
GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559
|| GLM_CONFIG_UNRESTRICTED_FLOAT, "'slerp' only accept floating-point inputs");
...
{
GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559
|| GLM_CONFIG_UNRESTRICTED_FLOAT, "'isnan' only accept floating-point inputs");
...
{
GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559
|| GLM_CONFIG_UNRESTRICTED_FLOAT, "'isinf' only accept floating-point inputs");
